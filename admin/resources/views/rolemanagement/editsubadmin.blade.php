...
<div class="py-5 lg:py-1">
    <div class="flex justify-between items-center py-3 w-[95%] mx-auto flex-wrap">
        <div class="me-5 mb-5 lg:mb-0">
            <h2 class="text-lg font-medium text-black dark:text-white mb-2">{{ __('Edit Subadmin') }}</h2>
  ...
  <path fill-rule="evenodd" d="M11.293 3.293a1 1 0 0 1 1.414 0l6 6 2 2a1 1 0 0 1-1.414 1.414L19 12.414V19a2 2 0 0 1-2 2h-3a1 1 0 0 1-1-1v-3h-2v3a1 1 0 0 1-1 1H7a2 2 0 0 1-2-2v-6.586l-.293.293a1 1 0 0 1-1.414-1.414l2-2 6-6Z" clip-rule="evenodd"/>
                    ...
                    <li aria-current="page">
                        <div class="flex items-center">
                            ...
                            <span class="ms-1 text-xs font-medium text-black md:ms-2 dark:text-white">{{ __('Edit Subadmin') }}</span>
                        </div>
                    </li>
                </ol>
            </nav>
                            ...
                            <div class="p-4 rounded-lg" id="default-group" role="tabpanel"
                                ...
                                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 gap-5">
                                    ...
                                    <div class="col-span-1 md:col-span-1 lg:col-span-1 mb-5" >
                                        ...
                                        <form name="editsubadmin" id="editsubadmin" method="POST" action="{{ route('subadmin.update') }}"enctype="multipart/form-data"
                                           ...
                                           @csrf
                                            ...
                                            <div class="mb-5">
                                                ...
                                                <input type="text" id="sadmin_name" name="sadmin_name"
                                                    ...
                                                    placeholder="" value="{{ $show_editsubadmin->admin_username }}" required aria-describedby="adminname-error">
                                            ...
                                            <div class="mb-5">
                                                ...
                                                <input type="type" id="sadmin_email" name="sadmin_email"
                                                    class="text-sm rounded-lg focus:ring-neutral-500 focus:border-neutral-500 block w-full p-2.5 dark:bg-neutral-900 dark:text-white border border-neutral-200 dark:border-neutral-800  dark:placeholder-neutral-400 dark:focus:ring-neutral-500 dark:focus:border-neutral-500"
                                                    placeholder="" value="{{ $show_editsubadmin->admin_email }}" required aria-describedby="adminemail-error">
                                    ...
                                    <div class="flex items-center space-x-2">
                                        ...
                                        <label class="relative inline-flex items-center cursor-pointer">
                                            <input type="checkbox" class="sr-only peer" name="admin_status" id="admin_status"  value="1" onchange="updateText()" @if($show_editsubadmin->admin_status == "enable") checked @endif />
                                ...
                                <input aria-label="label" type="hidden" name="sadmin_id" id="sadmin_id" value="{{ $show_editsubadmin->admin_id }}">
                                <input aria-label="label" type="hidden" name="admincheck" id="admincheck" value="{{$show_editsubadmin->allaccess_control }}">  
...
class FormHandler {
  ...
  initializeElements() {
    this.elements = {
      form: document.getElementById('editsubadmin'),
    };
  }
