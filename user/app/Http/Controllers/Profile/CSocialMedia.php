...
<?php
     ...
     class Controller_Profile_CSocialMedia extends BaseController
     {
         /**
          ...
          * @return HTML data
          */
         public static function updateSocialMediaDetails()
         {
             try {
                 $user_id  = $_SESSION['default']['customer_id'];
                 $meta_key = Model\Profile\MSocialMedia::getSocialMediaDetails($user_id);
                 Model\Profile\MSocialMedia::updateSocialMediaDetails($meta_key);
             } catch (Exception $e) {
