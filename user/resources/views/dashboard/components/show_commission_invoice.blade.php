...
>
                ...
                <div>
                    <button type="button"
                        class="py-2.5 px-5 me-2 mb-2 text-sm font-medium text-black dark:text-white focus:outline-none bg-white rounded-lg border border-neutral-200 hover:bg-neutral-100  focus:z-10 focus:ring-4 focus:ring-neutral-100 dark:focus:ring-neutral-700 dark:bg-neutral-900  dark:hover:text-white dark:hover:bg-neutral-700"
                        id="downloadBtn">Download Invoice</button>

                    <div class="rounded-lg overflow-x-auto md:overflow-x-visible mt-4 md:mt-0 border md:border-0"
                        id="default-group" role="tabpanel" aria-labelledby="profile-tab">
      ...
      try {
        ...
        domtoimage.toPng(clone)
          .then(function (dataUrl) {
            ...
            // Save the PDF
            pdf.save('CommissionInvoice.pdf');
          })
          .catch(function (error) {
            console.error('Error generating image:', error);
            console.log('Failed to generate PDF due to style compatibility issues.');
          });
      } catch (error) {
        console.log('Error during cloning or PDF generation:', error);
