...
<!-- Main modal -->
<div id="totalCommisionModal" tabindex="-1" aria-hidden="true"
  class="hidden  fixed top-0 right-0 left-0 z-50 justify-center items-center w-full md:inset-0 h-[calc(100%-1rem)] max-h-full">
  <div class="relative p-1 w-full max-w-5xl max-h-full overflow-y-auto overflow-x-hidden h-3/4">
    <!-- Modal content -->
    <div class="relative bg-white rounded-lg shadow-sm dark:bg-neutral-900 dark:text-white border border-neutral-200 dark:border-neutral-800">
      ...
      <div class="flex items-center justify-between p-4 md:p-5 border-b rounded-t  border-neutral-200">
        <h3 class="text-xl font-semibold text-black dark:text-white"> {{ __('Total Commission') }}  </h3>
        <button type="button" onclick="closeModal('totalCommisionModal')"
        ...
        <div class="datatable-wrapper datatable-loading no-footer sortable searchable fixed-columns">
          <div class="datatable-container">
            ...
            <div class="items-per-page-container">
                <label for="items-per-page dark:text-white">{{ __('Items per page:') }}</label>
                <select id="totalCommisionModal-per-page" 
                ...
                onchange="updatePerPage('totalCommisionTable', this.value,'gettotalcommisions')">
            ...
            <table id="totalCommisionTable" data-table-id="table4" class="border border-neutral-200">
              <thead>
                <tr>
                  <th>
                  ...
                  <th>
                    <span class="flex items-center"> {{ __('Type') }}
                      <svg class="w-4 h-4 ms-1" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24"
                        height="24" fill="none" viewBox="0 0 24 24">
                        <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                          d="m8 15 4 4 4-4m0-6-4-4-4 4" />
                  ...
                  <th>
                    <span class="flex items-center"> {{ __('Invoice') }}
                      <svg class="w-4 h-4 ms-1" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24"
                        height="24" fill="none" viewBox="0 0 24 24">
                        <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                          d="m8 15 4 4 4-4m0-6-4-4-4 4" />
              ...
              <tbody>
                ...
                <div id="totalCommisionTablePagination"></div>  <!-- ✅ This will be selected -->
          </div>
        </div>
      ...
      <div class="flex items-center justify-end p-4 md:p-5  border-neutral-200 rounded-b ">
        ...
        <a href="/user/transactionhistory">
          <button type="button"
...
>{{ __('View all transaction') }}</button>
        </a>
