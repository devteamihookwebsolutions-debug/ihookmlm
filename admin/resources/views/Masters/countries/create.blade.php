                            ...
                            <ol class="inline-flex items-center space-x-1 md:space-x-1 rtl:space-x-reverse">
                                ...
                                <li aria-current="page">
                                    <div class="flex items-center">
                                        ...
                                        <span class="text-xs font-medium text-gray-500 dark:text-gray-400">Country Create</span>
                                    </div>
                                </li>
                            </ol>
                   </div>
                ...
                <div class="bg-white dark:bg-gray-900 border dark:border-gray-800 rounded-lg p-6 min-h-screen overflow-auto">
                  <div class="grid grid-cols-2">
                    ...
                    <div class="flex justify-between items-center mb-6">
                        <h1 class="text-sm font-semibold text-gray-600 dark:text-gray-300">Create Country</h1>
                    ...
                    <form action="{{ route('countries.store') }}" method="POST">
                        ...
                        <div  class="space-y-3">
                            <div>
                                <label for="sortname" class="block mb-3 text-xs text-gray-600 dark:text-gray-300">Sort Name</label>
                                <input type="text" id="sortname" name="sortname" maxlength="3" class="bg-gray-50 border border-gray-300 text-gray-600 text-xs rounded-lg block w-full p-2 dark:bg-gray-800 dark:border-gray-700 dark:text-gray-300"  oninput="this.value=this.value.toUpperCase()" required>
                            ...
                            <div>
                                ...
                                <input type="text" id="country_master_name" name="country_master_name" maxlength="150" class="bg-gray-50 border border-gray-300 text-gray-600 text-xs rounded-lg block w-full p-2 dark:bg-gray-800 dark:border-gray-700 dark:text-gray-300" required>
