...
/**
 * This class contains public functions related to InstallConnectMLM
 *
 * @package         InstallConnectMLM
 * @category        Controller
...
use Ecomputing\App\Model\Wordpress\MInstallConnectMLM;
class InstallConnectMLM extends Controller
{
	/**
    ...
    */
     ...
     *
     */
    public static function wpTable(){
		MInstallConnectMLM::wpTable($_POST);
	}
