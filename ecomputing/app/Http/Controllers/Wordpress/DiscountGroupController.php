...
/**
 * This class contains public functions related to DiscountGroupController
 *
 * @package         DiscountGroupController
 * @category        Controller
...
use Ecomputing\App\Model\Wordpress\MDiscountGroup;
class DiscountGroupController extends Controller
{
    ...
    */
    ...
    {
        $discountGroup = new MDiscountGroup();
        $discountGroup->checkDiscountGroupUser();
    }

    public function getDiscountGroup()
    {
        $discountGroup = new MDiscountGroup();
        $discountGroup->getDiscountGroup();
    }
