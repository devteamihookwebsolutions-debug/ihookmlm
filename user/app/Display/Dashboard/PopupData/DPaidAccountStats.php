...
/**
 * This class contains public functions related to DPaidAccountStats
 *
 * @package         DPaidAccountStats
 * @category        Display
...
class DPaidAccountStats
{
    ...
    public static function getPaidAccountStats($records,$iTotal)
    {
