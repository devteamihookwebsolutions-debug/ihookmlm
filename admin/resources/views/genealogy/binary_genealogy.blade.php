                ...
                <ol class="inline-flex items-center space-x-1 md:space-x-1 rtl:space-x-reverse">
                    ...
                    <li aria-current="page">
                        <div class="flex items-center">
                            ...
                            <span class="text-xs font-medium text-gray-500 dark:text-gray-400">Classic
                                View</span>
                        </div>
                    </li>
                </ol>
                ...
                <div
                    ...
                    <div class="flex items-center justify-between space-x-4" bis_skin_checked="1">
                        ...
                        <div class="w-full max-w-xs" bis_skin_checked="1">
                            <select id="default_matrix" name="default_matrix"
                                class="bg-gray-50 border border-gray-300 text-gray-600 text-xs rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-gray-300 dark:focus:ring-blue-500 dark:focus:border-blue-500">
                            ...
                            <div id="search-combobox" class="relative" data-hs-combo-box="">
                                <div class="relative w-80">
                                    <input type="text" name="searchbox" id="searchbox"
                                        class="block w-full p-2  bg-gray-50 border border-gray-300 text-gray-600 text-xs rounded-lg block w-full p-2 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-gray-300"
                                        placeholder="Search..." aria-expanded="false"
                                        data-hs-combo-box-input=""
                                        onkeyup="filterSuggestions(this.value)" />
                                    <button type="button" onclick="genealogySearch();"
                                        class="absolute top-0 end-0 p-2.5 h-full text-xs font-medium text-white bg-blue-700 rounded-e-lg border border-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800"
                    ...
                    <div class="relative ">
                        <div id="contentpanel" class="mt-5">
                            <!-- bpcontent -->
                            <div id="westpanel"
                                class="hidden p-4 border border-gray-400 text-sm text-gray-700 overflow-scroll">
                                <p id="pageFitMode"></p>
...
@include('genealogy.components.binary_genealogy_script')
@endsection
