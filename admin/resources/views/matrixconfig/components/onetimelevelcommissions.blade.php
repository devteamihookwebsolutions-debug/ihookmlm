<div id="onetimelevelcommissions-modal" tabindex="-1" aria-hidden="true"
    ...
    <div class="relative p-4 w-full max-w-3xl max-h-full">
        ...
        <div  class="relative bg-white rounded-lg shadow dark:bg-gray-700">
            ...
            <div class="flex items-center justify-between p-4 md:p-5 border-b rounded-t dark:border-gray-600">
                ...
                {{ __('Level Commission') }}</h3>
                <button type="button" onclick="closeModal('onetimelevelcommissions-modal')"
            ...
            <div class="space-y-4">
                ...
                <div class="mb-5">
                    ...
                    <div id="onetimelevel_on_fields" class="mt-5">
                        <div class="form-submit" id="onetimelevelcommission">

                            <!-- Main Modal -->
                            <div tabindex="-1" aria-hidden="true" class="">
                                <div class="relative p-4 w-full max-w-5xl max-h-full">
                                    <!-- Modal content -->
                                    <div class="">
                                        <div class="flex justify-end mb-10">
                                            <button id="add-onetime-button"
                                        ...
                                        <div
                                            ...
                                            <div class="datatable-container">
                                                <table id="search-table" class="datatable-table">
                                                    ...
                                                    <tbody id="onetime-level-table-body">
                                                        <tr id="no-data-row">
