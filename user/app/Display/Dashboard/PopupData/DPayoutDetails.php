...
/**
 * This class contains public functions related to DPayoutDetails
 *
 * @package         DPayoutDetails
 * @category        Display
...
class DPayoutDetails
{
    public static function getPayoutDetails($records, $iTotal)
    {
