...
/**
 * This class contains public functions related to DDirectDownLineDetails
 *
 * @package         DDirectDownLineDetails
 * @category        Display
...
class DDirectDownLineDetails
{
    ...
    public static function getDirectDownLineDetails($records,$iTotal)
    {
