...
<div class="py-5 lg:py-1">
    <div class="flex justify-between items-center py-3 flex-wrap w-[95%] mx-auto">
        ...
        <h2 class="text-lg font-medium text-black dark:text-white  mb-2">{{ __('Collapse View') }}</h2>
                ...
                <ol class="inline-flex items-center space-x-1 md:space-x-2 rtl:space-x-reverse">
                    ...
                    <li aria-current="page">
                        <div class="flex items-center">
                            ...
                            <span
                                class="ms-1 text-xs font-medium text-black md:ms-2 dark:text-white">{{ __('Collapse View') }}</span>
                        </div>
                    </li>
                </ol>
            </nav>
...
@include('genealogy.components.collapse_script')
@endsection
