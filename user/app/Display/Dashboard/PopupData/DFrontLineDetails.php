...
/**
 * This class contains public functions related to DFrontLineDetails
 *
 * @package         DFrontLineDetails
 * @category        Display
...
class DFrontLineDetails
{
    ...
    public static function getFrontLineDetails($records,$iTotal)
    {
