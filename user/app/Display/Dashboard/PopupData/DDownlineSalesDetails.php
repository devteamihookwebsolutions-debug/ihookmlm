...
/**
 * This class contains public functions related to DDownlineSalesDetails
 *
 * @package         DDownlineSalesDetails
 * @category        Display
...
class DDownlineSalesDetails
{
    ...
    public static function getDownlineSalesDetails($records, $iTotal)
    {
