...
/**
 * This class contains public functions related to MHasPeriodicGPV
 *
 * @package         MHasPeriodicGPV
 * @category        Model
...
class MHasPeriodicGPV{
     ...
     * @return Boolean data
    */
public static function hasPeriodicGPV($Userarray, $gpv_value, $matrix_id, $from_datetime, $to_datetime, $condition)
    {
        ...
        if ($from_datetime != "" || $to_datetime != "") {
            $pv_sql = "SELECT SUM(history_amount) AS total_pv FROM " . $_ENV['PROMLM_PREFIX'] . "history_table
                ...
                history_datetime<='" . $to_datetime . "') AND  history_member_id IN (" . $arr_members . ") AND
