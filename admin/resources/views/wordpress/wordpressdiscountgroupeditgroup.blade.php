...
<div class="py-5 lg:py-1">
    <div class="flex justify-between items-center py-3 w-[95%] mx-auto flex-wrap">
        <div class="me-5 mb-5 lg:mb-0">
            <h2 class="text-lg font-medium text-black dark:text-white mb-2">{{ __('Status') }}Edit Group Name</h2>
  ...
  <path fill-rule="evenodd" d="M11.293 3.293a1 1 0 0 1 1.414 0l6 6 2 2a1 1 0 0 1-1.414 1.414L19 12.414V19a2 2 0 0 1-2 2h-3a1 1 0 0 1-1-1v-3h-2v3a1 1 0 0 1-1 1H7a2 2 0 0 1-2-2v-6.586l-.293.293a1 1 0 0 1-1.414-1.414l2-2 6-6Z" clip-rule="evenodd"/>
                    ...
                    <li aria-current="page">
                        <div class="flex items-center">
                            ...
                            <span class="ms-1 text-xs font-medium text-black md:ms-2 dark:text-white">{{ __('Status') }}Discount Group</span>
                        </div>
                    </li>
                    <li aria-current="page">
                        <div class="flex items-center">
                            ...
                            <span class="ms-1 text-xs font-medium text-black md:ms-2 dark:text-white">{{ __('Status') }}Edit Group Name</span>
                        </div>
                    </li>
                </ol>
            </nav>
...
<main class="flex-grow">
    ...
    <div>
        <div class="p-4 rounded-lg">
            <div class="flex items-center">
                <div>
                    <h3 class="text-lg font-semibold text-black mb-10 dark:text-white">{{ __('Edit Group Name') }}</h3>
                </div>
            </div>
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 gap-5">
                <div class="col-span-1 md:col-span-1 lg:col-span-1 mb-5">
                    <form  name="showeditgroup" id="showeditgroup" method="POST" action="{{$_ENV['BCPATH']}}/wordpressdiscountgroup/editupdategroup" enctype="multipart/form-data">
                        <div class="mb-5">
                            <label for="" class="block mb-2 text-sm font-medium text-black dark:text-white">{{ __('Group Name') }}</label>
                            <input type="text" name="group_name" id="group_name"  value="{{$errval['group_name']}}" 
                                        ...
                                        <td class="px-6  text-right">
                                            <div class="flex items-center p-2.5">
                                                ...
                                                <label class="inline-flex items-center cursor-pointer mx-3">
                                                    <input type="checkbox" name="status" id="status" value="1" class="sr-only peer" @if($errval['status'] == '1') checked @endif>
                                                    <div
                                    ...
                                    <tr>
                                        ...
                                        <td class="px-6  text-right">
                                            <div class="flex items-center p-2.5">
                                                ...
                                                <!-- Toggle switch -->
                                                <label class="inline-flex items-center cursor-pointer mx-3">
                                                    <input type="checkbox" name="cart_status" id="cart_status" value="1" class="sr-only peer"  @if($errval['cart_status'] == '1') checked @endif>
                                                    <div
                                                        class="relative w-11 h-6  bg-neutral-200 peer-focus:outline-none peer-focus:ring-4 peer-focus:ring-neutral-300 dark:peer-focus:ring-orange-800 rounded-full peer dark:bg-neutral-900 dark:text-white border border-neutral-200 dark:border-neutral-800 peer-checked:after:translate-x-full rtl:peer-checked:after:-translate-x-full peer-checked:after:border-white after:content-[''] after:absolute after:top-[2px] after:left-[2px] after:bg-white after:border-neutral-300 after:border after:rounded-full after:w-5 after:h-5 after:transition-all  peer-checked:bg-neutral-900">
                                                    </div>
                                                </label>
                        ...
                        <input aria-label="label" type="hidden" value="{{$group_id}}" name="group_id">
