                        ...
                        <div
                            ...
                            <button
                                ...
                                @click.stop="sidebarToggle = !sidebarToggle">
                                 <svg class="w-6 h-6 hidden text-blue-500 xl:block" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
                                ...
                                <svg :class="sidebarToggle ? 'hidden' : 'block xl:hidden'"
                                    class="text-blue-500 xl:hidden" width="24" height="24" viewBox="0 0 24 24"
                                    fill="none">
                                  <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M7.99994 10 6 11.9999l1.99994 2M11 5v14m-7 0h16c.5523 0 1-.4477 1-1V6c0-.55228-.4477-1-1-1H4c-.55228 0-1 .44772-1 1v12c0 .5523.44772 1 1 1Z"/>
                                </svg>
                        ...
                        <div :class="menuToggle ? 'flex' : 'hidden'"
                            ...
                            <div class="relative" x-data="{ dropdownOpen: false, notifying: true }"
                                ...
                                <div x-show="dropdownOpen"
                                    class="dark:bg-gray-900 absolute mt-3 flex h-[480px] w-auto flex-col rounded-2xl border border-gray-200 bg-white p-3 sm:w-[361px] lg:right-0 dark:border-gray-800 dark:bg-gray-900">
                                    <div
                                        ...
                                        <button @click="dropdownOpen = false" class="text-gray-500 dark:text-gray-400">
                                            <svg class="fill-current w-5 h-5" width="24" height="24" viewBox="0 0 24 24"
                                                fill="none">
                                                <path fill-rule="evenodd" clip-rule="evenodd"
                                                    d="M6.21967 7.28131C5.92678 6.98841 5.92678 6.51354 6.21967 6.22065C6.51256 5.92775 6.98744 5.92775 7.28033 6.22065L11.999 10.9393L16.7176 6.22078C17.0105 5.92789 17.4854 5.92788 17.7782 6.22078C18.0711 6.51367 18.0711 6.98855 17.7782 7.28144L13.0597 12L17.7782 16.7186C18.0711 17.0115 18.0711 17.4863 17.7782 17.7792C17.4854 18.0721 17.0105 18.0721 16.7176 17.7792L11.999 13.0607L7.28033 17.7794C6.98744 18.0722 6.51256 18.0722 6.21967 17.7794C5.92678 17.4865 5.92678 17.0116 6.21967 16.7187L10.9384 12L6.21967 7.28131Z"
                                                    fill="" />
                                    ...
                                    <ul class="no-scrollbar flex h-auto flex-col overflow-y-auto">
                                        <li>
                                            <a class="flex gap-3 rounded-lg border-b border-gray-100 p-3 px-4.5 py-3 hover:bg-gray-100 dark:border-gray-800 dark:hover:bg-white/5"
                                                ...
                                                <span class="relative z-1 block h-10 w-full max-w-10 rounded-full">
                                                    <img src="img/user-01.jpg" alt="User"
                                                ...
                                                <span class="block">
                                                    <span class="text-xs mb-1.5 block text-gray-500 dark:text-gray-500">
                                                        <span
                                                            class="font-normal text-gray-800 dark:text-gray-300 mr-3">Terry
                                                            Franci</span>
                                                        requests permission to change
                                                        <span
                                                            class="font-normal text-gray-800 dark:text-gray-500">Project
                                                            - Nganter App</span>
                                                    </span>
                                                    <span
                                        ...
                                        <li>
                                            <a class="flex gap-3 rounded-lg border-b border-gray-100 p-3 px-4.5 py-3 hover:bg-gray-100 dark:border-gray-800 dark:hover:bg-white/5"
                                                href="#">
                                                <span class="relative z-1 block h-10 w-full max-w-10 rounded-full">
                                                    <img src="img/user-03.jpg" alt="User"
                                                        class="overflow-hidden rounded-full" />
                                                    <span
                                                        class="bg-success-500 absolute right-0 bottom-0 z-10 h-2.5 w-full max-w-2.5 rounded-full border-[1.5px] border-white dark:border-gray-900"></span>
                                                </span>
                                                <span class="block">
                                                    <span class="text-xs mb-1.5 block text-gray-500 dark:text-gray-500">
                                                        <span
                                                            class="font-normal text-gray-800 dark:text-gray-300 mr-3">Alena
                                                            Franci</span>
                                                        requests permission to change
                                                        <span
                                                            class="font-normal text-gray-800 dark:text-gray-500">Project
                                        ...
                                        <li>
                                            <a class="flex gap-3 rounded-lg border-b border-gray-100 p-3 px-4.5 py-3 hover:bg-gray-100 dark:border-gray-800 dark:hover:bg-white/5"
                                                href="#">
                                                <span class="relative z-1 block h-10 w-full max-w-10 rounded-full">
                                                    <img src="img/user-05.jpg" alt="User"
                                                        class="overflow-hidden rounded-full" />
                                                    <span
                                                        class="bg-success-500 absolute right-0 bottom-0 z-10 h-2.5 w-full max-w-2.5 rounded-full border-[1.5px] border-white dark:border-gray-900"></span>
                                                </span>
                                                <span class="block">
                                                    <span class="text-xs mb-1.5 block text-gray-500 dark:text-gray-500">
                                                        <span
                                                            class="font-normal text-gray-800 dark:text-gray-300 mr-3">Jocelyn
                                                            Kenter</span>
                                                        requests permission to change
                                                        <span
                                                            class="font-normal text-gray-800 dark:text-gray-500">Project
                                        ...
                                        <li>
                                            <a class="flex gap-3 rounded-lg border-b border-gray-100 p-3 px-4.5 py-3 hover:bg-gray-100 dark:border-gray-800 dark:hover:bg-white/5"
                                                href="#">
                                                <span class="relative z-1 block h-10 w-full max-w-10 rounded-full">
                                                    <img src="img/profile-picture-5.jpg" alt="User"
                                                        class="overflow-hidden rounded-full" />
                                                    <span
                                                ...
                                                <span class="block">
                                                    <span class="text-xs mb-1.5 block text-gray-500 dark:text-gray-500">
                                                        <span
                                                            class="font-normal text-gray-800 dark:text-gray-300 mr-3">Brandon
                                                            Philips</span>
                                                        requests permission to change
                                                        <span
                                                            class="font-normal text-gray-800 dark:text-gray-500">Project
                                    ...
                                    <a href="#"
                                        class="text-xs mt-3 text-center mx-auto justify-center flex w-40 rounded-lg border bg-gray-800 p-2 font-medium text-white hover:bg-gray-900 dark:border-blue-600 dark:bg-blue-500 dark:text-white dark:hover:bg-blue-600 ">
                            ...
                            <div class="relative">
                                <button class="p-2 rounded-full hover:bg-gray-100 focus:ring-2 focus:ring-gray-300 dark:hover:bg-blue-500" onclick="openWordpressAutoLogin({{ $member->members_id }})">
                            ...
                            <div class="relative">
                                <button id="user-menu-button" data-dropdown-toggle="user-dropdown"
                                    ...
                                    type="button">
                                    <img class="w-10 h-10 rounded-full" src="/img/profile-picture-3.jpg"
                                        alt="user photo">
                                </button>

                                <!-- Dropdown menu -->
                                <div id="user-dropdown"
                                    class="z-10 hidden mr-20 bg-white border divide-y divide-gray-100 rounded-lg shadow w-56 dark:bg-gray-900 dark:divide-gray-700 dark:border-gray-800"
                                    data-close-on-click="inside">
                                    <div class="px-4 py-3">
                                        <span class="block text-sm font-semibold text-gray-900 dark:text-white">Cody
                                            Fisher</span>
                                        <span
                                            class="block text-xs text-gray-500 truncate dark:text-blue-500">c.fisher@gmail.com</span>
                                        <span
                                            class="inline-block text-xs text-blue-600 dark:text-blue-400 font-semibold">Pro</span>
                                    </div>
                                    ...
                                    <ul class="py-2 text-xs text-gray-700 dark:text-gray-200"
                                        ...
                                        <li>
                                            <a href="#"
                                                class="block px-4 py-2 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white">Public
                                                Profile</a>
                                        </li>
                                        <li>
                                            <a href="{{ '/user/profile/myprofile' }}"
                                        ...
                                        <li>
                                            <a href="#"
                                                class="block px-4 py-2 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white">Dev
                                                Forum</a>
                                        </li>
                                        <li>
                                            <a href="#"
                                                class="flex text-xs items-center justify-between px-4 py-2 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white">
                                                <span>Language</span>
                                                <span class="flex items-center gap-1">
                                                    English
                                                    <img src="https://flagcdn.com/w20/us.png" class="w-4 h-4"
                                                        alt="us flag">
                                                </span>
                                            </a>
                                        </li>
                                    ...
                                    <div class="py-2 text-center mb-4">
                                        <div class="flex items-center justify-between px-4 py-2 mb-5">
                                            <!-- Dark Mode Toggle -->
                                        ...
                                        <a href="#"
                                            class="px-6 py-1 mb-3 rounded-2xl text-center text-sm text-white font-semibold bg-gray-800 hover:bg-gray-900 dark:hover:bg-blue-600 dark:bg-blue-500">Logout</a>
                                    </div>
                                </div>
                            </div>
                            <!-- User Area -->
