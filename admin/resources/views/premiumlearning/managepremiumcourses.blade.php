...
<main class="flex-grow">
    <div class="w-[95%] mx-auto px-4 sm:px-6 lg:px-0 py-6 lg:py-3">
        ...
        <div class="bg-neutral-800 text-white border border-neutral-800 rounded-lg p-6 space-x-6 items-center mb-5" role="alert">
                            <div>
                                <div class="flex justify-between items-center flex-wrap">
                                    <div class="flex gap-2">
                                        <h3 class="text-4xl text-neutral-100 mb-4">{{ __('Successful way to promote your Elearning') }}</h3>
                                    </div>
                                    <div class="flex gap-2">
                    ...
                    <div class="p-4 rounded-lg">
                        ...
                        <div class="flex justify-end items-center">
                            <ul class="flex space-x-2">
                                <li>
                                    <a aria-label="link" href="{{ $_ENV['BCPATH'] }}/showelearning/show"
...
<script>
   ...
   function deleteCourse(id) {
    console.log(id);  // Debugging to ensure the course ID is passed correctly
    Swal.fire({
        ...
        if (result.isConfirmed) {
            Swal.fire({
                ...
                window.location.href = `{{$_ENV['BCPATH']}}/elearning/deletecourse/${id}`;
            });
        } else {
            Swal.fire({
                title: "{{ __('Cancelled') }}",
...
// if (document.getElementById("data-table") && typeof simpleDatatables.DataTable !== 'undefined') {
