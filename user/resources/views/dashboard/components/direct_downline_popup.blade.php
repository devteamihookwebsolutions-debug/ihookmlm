...
<!-- Main modal -->
<div id="directDownlinesModal" tabindex="-1" aria-hidden="true"
  ...
  <div class="relative p-4 w-full max-w-5xl max-h-full">
    ...
    <div class="relative bg-white rounded-lg shadow-sm dark:bg-neutral-900 dark:text-white border border-neutral-200 dark:border-neutral-800">
      ...
      <div class="flex items-center justify-between p-4 md:p-5 border-b rounded-t  border-neutral-200">
        <h3 class="text-xl font-semibold text-black dark:text-white">{{ __('Direct Downlines') }} </h3>
        <button type="button" onclick="closeModal('directDownlinesModal')"
        ...
        <div class="datatable-wrapper datatable-loading no-footer sortable searchable fixed-columns">
          <div class="datatable-container">
            ...
            <div class="items-per-page-container">
                ...
                <select id="directDownlinesModal-per-page" 
                ...
                onchange="updatePerPage('directDownlinesTable', this.value,'getdirectdownlinesdetails')">
            ...
            <table id="directDownlinesTable" data-table-id="table3" >
              <thead>
                <tr>
                  <th>
            ...
            <div id="directDownlinesTablePagination" class="pagination"></div>
          </div>
        </div>
