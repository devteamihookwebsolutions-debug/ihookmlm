...
<div class="py-5 lg:py-1">
    <div class="flex justify-between items-center py-3 flex-wrap w-[95%] mx-auto">
        ...
        <h2 class="text-lg font-medium text-black dark:text-white  mb-2">{{ __('Rank View') }}</h2>
                ...
                <ol class="inline-flex items-center space-x-1 md:space-x-2 rtl:space-x-reverse">
                    ...
                    <li aria-current="page">
                        <div class="flex items-center">
                            ...
                            <span
                                class="ms-1 text-xs font-medium text-black md:ms-2 dark:text-white">{{ __('Rank View') }}</span>
                        </div>
                    </li>
                </ol>
            </nav>
    ...
    <div class="w-[95%] mx-auto px-4 sm:px-6 lg:px-0 py-6 lg:py-3">
        ...
        <div class="bg-white rounded-lg shadow-sm p-6 mb-5 dark:border-neutral-700 dark:bg-neutral-900 dark:text-white border border-neutral-200">
            ...
            <div class="flex items-center justify-between space-x-4" bis_skin_checked="1">
                ...
                <!-- Second Dropdown -->
                <div class="w-full max-w-xs flex" bis_skin_checked="1">
                    ...
                    <!-- Button -->
                        ...
                        class="text-white font-medium rounded-full text-sm px-3 py-3 text-center mr-5">
            ...
            <ul class="rank_color flex mt-2">{!! $rankcolors !!}</ul>
                <div id="grptree"></div>
