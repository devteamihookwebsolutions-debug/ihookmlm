...
@section('content')
<!-- custom styles start-->
<!-- <link href="{{ asset('css/defaultstyle.css') }}" rel="stylesheet" type="text/css" /> -->
<!-- custom styles end-->
                            ...
                            <ol class="inline-flex items-center space-x-1 md:space-x-1 rtl:space-x-reverse">
                                ...
                                <li aria-current="page">
                                    <div class="flex items-center">
                                        ...
                                        <span class="text-xs font-medium text-gray-500 dark:text-gray-400">Tabular View</span>
                                    </div>
                                </li>
                            </ol>
                        </div>
...
<!-- Content area -->
       ...
       <!-- Main content -->
                        ...
                        @endforeach
                                     ...
                                     <div class="overflow-y-auto flex align-center justify-center">
...
@include('genealogy.components.tabular_script')
@endsection
<script>
    // Switch matrix on dropdown change
    document.getElementById('default_matrix').addEventListener('change', function() {
        const matrixId = this.value;
        const type = "{{ $graphicalGenealogyType ?? 'grpgenealogy' }}";
        if (matrixId) {
            window.location = `/admin/${type}/viewtree/${matrixId}`;
        }
    });
