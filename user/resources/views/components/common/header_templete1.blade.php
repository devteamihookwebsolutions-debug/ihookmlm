...
<script src="https://cdn.jsdelivr.net/npm/apexcharts"></script>
 <script
            src="https://cdn.jsdelivr.net/npm/apexcharts@3.46.0/dist/apexcharts.min.js"></script>
                   ...
                   <!-- worldmap graph -->
        <script src="js/worldmap graph/d3.min.js"></script>
        <script src="js/worldmap graph/topojson.min.js"></script>
        <script src="js/worldmap graph/datamaps.world.min.js"></script>
