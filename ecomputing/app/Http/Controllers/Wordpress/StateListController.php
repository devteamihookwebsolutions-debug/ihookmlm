...
/**
 * This class contains public functions related to StateListController
 *
 * @package         StateListController
 * @category        Controller
...
use Ecomputing\App\Model\Wordpress\MStateList;
class StateListController extends Controller
{
    ...
    */
    ...
    public function getStateList($id)
    {
        ...
        return $stateList->getStateList($id);
    }
