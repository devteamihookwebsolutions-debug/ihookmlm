...
<!-- Main modal -->
<div id="downlineSalesModal" tabindex="-1" aria-hidden="true"
  ...
  <div class="relative p-4 w-full max-w-5xl max-h-full">
    ...
    <div class="relative bg-white rounded-lg shadow-sm dark:bg-neutral-900 dark:text-white border border-neutral-200 dark:border-neutral-800">
      ...
      <div class="flex items-center justify-between p-4 md:p-5 border-b rounded-t  border-neutral-200">
        <h3 class="text-xl font-semibold text-black dark:text-white"> {{ __('Downline Sales') }}  </h3>
        <button type="button" onclick="closeModal('downlineSalesModal')"
        ...
        <div class="datatable-wrapper datatable-loading no-footer sortable searchable fixed-columns">
          <div class="datatable-container">
            ...
            <div class="items-per-page-container">
                ...
                <select id="downlineSalesModal-per-page" 
                ...
                onchange="updatePerPage('downlineSalesTable', this.value,'getdownlinesalesdetails')">
            ...
            <div class="overflow-x-auto w-full">
              <table id="downlineSalesTable" data-table-id="table1" class="w-full min-w-[600px]">
              <thead>
                <tr>
                  <th>
              ...
              <tbody class="bg-white dark:bg-neutral-900">
                ...
                <div id="downlineSalesTablePagination"></div>  <!-- ✅ This will be selected -->
          </div>
        </div>
