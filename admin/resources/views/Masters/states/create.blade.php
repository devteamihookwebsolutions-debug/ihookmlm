                    ...
                    <form action="{{ route('admin.states.store') }}" method="POST">
                        ...
                        <div class="space-y-3">
                            <div>
                                ...
                                <input type="text" id="country_code" name="country_code" maxlength="10" class="bg-gray-50 border border-gray-300 text-gray-600 text-xs rounded-lg block w-full p-2 dark:bg-gray-800 dark:border-gray-700 dark:text-gray-300" required>
                                @error('country_code')
                            ...
                            <div>
                                ...
                                <input type="text" id="state_code" name="state_code" maxlength="500" class="bg-gray-50 border border-gray-300 text-gray-600 text-xs rounded-lg block w-full p-2 dark:bg-gray-800 dark:border-gray-700 dark:text-gray-300" required>
                                @error('state_code')
                                    <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                                @enderror
                            </div>
