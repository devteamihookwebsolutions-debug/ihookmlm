...
<div class="py-5 lg:py-1">
    <div class="flex justify-between items-center py-3 w-[95%] mx-auto flex-wrap">
        <div class="me-5 mb-5 lg:mb-0">
            <h2 class="text-lg font-medium text-black dark:text-white mb-2">{{ __('Add Newsletter Template') }}</h2>
...
>                                            {{ __('Cancel') }}</button></a>
                        ...
                        <!--image-space-->
                        <img src="" alt="add-customer" class="w-full sticky top-0 overflow-hidden">
                        <!--image-space-->
                    </div>
