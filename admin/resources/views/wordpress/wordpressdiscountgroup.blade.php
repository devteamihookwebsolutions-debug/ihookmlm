...
<div class="py-5 lg:py-1">
    <div class="flex justify-between items-center py-3 flex-wrap w-[95%] mx-auto">
        <div class="me-5 mb-5 lg:mb-0">
            <h2 class="text-lg font-medium text-black mb-2 dark:text-white">{{ __('Discount Group') }}</h2>
  ...
  <path fill-rule="evenodd" d="M11.293 3.293a1 1 0 0 1 1.414 0l6 6 2 2a1 1 0 0 1-1.414 1.414L19 12.414V19a2 2 0 0 1-2 2h-3a1 1 0 0 1-1-1v-3h-2v3a1 1 0 0 1-1 1H7a2 2 0 0 1-2-2v-6.586l-.293.293a1 1 0 0 1-1.414-1.414l2-2 6-6Z" clip-rule="evenodd"/>
                    ...
                    <li aria-current="page">
                        <div class="flex items-center">
                            ...
                            <span class="ms-1 text-xs font-medium text-black md:ms-2 dark:text-white">{{ __('E-Store') }}</span>
                        </div>
                    </li>
                    <li aria-current="page">
                        <div class="flex items-center">
            ...
            <div class="w-[95%] mx-auto px-4 sm:px-6 lg:px-0 py-6 lg:py-3">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-1 gap-5 mb-5">
                    ...
                    <div class="bg-white rounded-lg shadow-sm p-6 mb-5 dark:border-neutral-700 dark:bg-neutral-900 dark:text-white border border-neutral-200">
                        <div class="datatable-top flex justify-end" bis_skin_checked="1">
                            <a href="{{$_ENV['BCPATH']}}/wordpressdiscountgroup/addgroup"  class=" px-5 py-2.5 me-2 mb-2 rounded bg-neutral-800 text-white dark:bg-neutral-100 dark:text-black transition-all duration-300 shadow-md hover:scale-105">{{ __('Add') }}</a>
                        </div>
                      ...
                      <div class="w-full mx-auto p-4">
                        ...
                        <div class="overflow-x-auto">
                            ...
                            <thead class="bg-neutral-50">
                                <tr>
                                    <th>{{ __('SNo') }}</th>
                                    <th>{{ __('Discount Group') }}</th>
                                    <th>{{ __('Status') }}</th>
                                    <th>{{ __('Cart Status') }}</th>
                                    <th>{{ __('Action') }}</th>
                                </tr>
                            </thead>
