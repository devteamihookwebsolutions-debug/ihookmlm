...
<!-- Main modal -->
<div id="cWalletBalanceModal" tabindex="-1" aria-hidden="true"
  ...
  <div class="relative p-4 w-full max-w-5xl max-h-full">
    ...
    <div class="relative bg-white rounded-lg shadow-sm dark:bg-neutral-900 dark:text-white border border-neutral-200 dark:border-neutral-800">
      ...
      <div class="flex items-center justify-between p-4 md:p-5 border-b rounded-t  border-neutral-200">
        <h3 class="text-xl font-semibold text-black dark:text-white">{{ __('USD Balance') }} </h3>
        <button type="button" onclick="closeModal('cWalletBalanceModal')"
        ...
        <div class="datatable-wrapper datatable-loading no-footer sortable searchable fixed-columns">
          <div class="datatable-container">
            ...
            <div class="items-per-page-container">
                ...
                <select id="cWalletBalanceModal-per-page" 
                ...
                onchange="updatePerPage('cWalletBalanceTable', this.value,'getcwalletamountdetails')">
            ...
            <table id="cWalletBalanceTable" data-table-id="table3" >
                <thead>
                    <tr>
                      <th>
            ...
            <div id="cWalletBalanceTablePagination" class="pagination"></div>
          </div>
        </div>
