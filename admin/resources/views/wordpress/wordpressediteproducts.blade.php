                            ...
                            <div class="p-4 rounded-lg" id="default-group" role="tabpanel"
                                ...
                                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 gap-5">
                                    ...
                                    <div class="col-span-1 md:col-span-1 lg:col-span-1 mb-5" >
                                        <form class="mx-auto validated-form" novalidate name="edit_eshop_products" id="edit_eshop_products" method="POST" action="{{$_ENV['BCPATH']}}/wordpressproducts/insert" enctype="multipart/form-data">
                                        @csrf
                                        <h3 class="text-lg font-semibold text-black mb-10 dark:text-white">{{ __('Edit Products') }}</h3>
                                            <input aria-label="label" type="hidden" name="editposttitle" value="{{$post_title ?? ''}}">
                                            <input aria-label="label" type="hidden" name="id" value="{{$sub1 ?? ''}}">
                                                <div class="mb-5">
                                                    <label for="title"
                                                ...
                                                <div class="mb-5">
                                                    ...
                                                    <input type="text" id="post_regprice" name="post_regprice"
                                                        class="text-sm rounded-lg focus:ring-neutral-500 focus:border-neutral-500 block w-full p-2.5 dark:bg-neutral-900 dark:text-white border border-neutral-200 dark:border-neutral-800  dark:placeholder-neutral-400 dark:focus:ring-neutral-500 dark:focus:border-neutral-500"
                                                        placeholder="" value="{{$regular_price ?? ''}}" required aria-describedby="post_regprice-error">
                                                ...
                                                <div class="mb-5">
                                                    <label for="product_image" class="block mb-2 text-sm font-medium text-black dark:text-white">{{ __('Image') }}</label>
                                                    <input
                                                ...
                                                <!-- <p class="text-xs mt-2">
                                                    Allowed file format: png, jpg, svg (88 px X 50 px)
                                                </p> -->
                                            </div>


                                            <div class="flex justify-end">
                                                <button type="button" onclick="window.history.back();" class=" text-black dark:text-white bg-gray focus:outline-none hover:bg-neutral-100 focus:ring-4 focus:ring-neutral-100 font-medium rounded-lg text-sm px-5 py-2.5 me-2 mb-2 dark:bg-neutral-900  dark:hover:bg-neutral-800 dark:hover:border-neutral-600 dark:focus:ring-neutral-700 ">{{ __('Cancel') }}</button>
                                                <button type="submit"
...
class FormHandler {
  ...
  initializeElements() {
    this.elements = {
      form: document.getElementById('edit_eshop_products'),
    };
  }
