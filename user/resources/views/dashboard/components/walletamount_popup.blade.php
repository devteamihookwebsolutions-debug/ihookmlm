...
<!-- Main modal -->
<div id="walletAmountModal" tabindex="-1" aria-hidden="true"
  ...
  <div class="relative p-4 w-full max-w-5xl max-h-full">
    ...
    <div class="relative bg-white rounded-lg shadow-sm dark:bg-neutral-900 dark:text-white border border-neutral-200 dark:border-neutral-800">
      ...
      <div class="flex items-center justify-between p-4 md:p-5 border-b rounded-t  border-neutral-200">
        <h3 class="text-xl font-semibold text-black dark:text-white">{{ __('Wallet Amount') }} </h3>
        <button type="button" onclick="closeModal('walletAmountModal')"
        ...
        <div class="datatable-wrapper datatable-loading no-footer sortable searchable fixed-columns">
          <div class="datatable-container">
            ...
            <div class="items-per-page-container">
                ...
                <select id="walletAmountModal-per-page" 
                ...
                onchange="updatePerPage('walletAmountTable', this.value,'getwalletamountdetails')">
            ...
            <table id="walletAmountTable" data-table-id="table3" >
              <thead>
                <tr>
                  <th>
                  ...
                  <th>
                    <span class="flex items-center"> {{ __('Transaction') }}
                      <svg class="w-4 h-4 ms-1" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24"
                        height="24" fill="none" viewBox="0 0 24 24">
                        <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                          d="m8 15 4 4 4-4m0-6-4-4-4 4" />
            ...
            <div id="walletAmountTablePagination" class="pagination"></div>
          </div>
        </div>
