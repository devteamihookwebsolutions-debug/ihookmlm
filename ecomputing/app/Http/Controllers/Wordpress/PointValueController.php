...
/**
 * This class contains public functions related to PointValueController
 *
 * @package         PointValueController
 * @category        Controller
...
use Ecomputing\App\Model\Wordpress\MPointValue;
class PointValueController extends Controller
{
    ...
    */
    ...
    {
        MPointValue::sendProductPV();
    }

    public static function getproductPV()
    {
        MPointValue::getproduct_pv('33');
    }
}
?>
