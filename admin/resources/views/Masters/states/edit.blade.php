                            ...
                            <ol class="inline-flex items-center space-x-1 md:space-x-1 rtl:space-x-reverse">
                                ...
                                <li>
                                    <div class="flex items-center">
                                        ...
                                        <a href="#"
                                            class=" text-xs font-medium text-gray-500 hover:text-blue-600  dark:text-gray-400 dark:hover:text-white">{{ __('States Edit') }}</a>
                                    </div>
                                </li>
                                <li aria-current="page">
                                    <div class="flex items-center">
                                        ...
                                        <span class="text-xs font-medium text-gray-500 dark:text-gray-400">{{ __('States Edit') }}</span>
                                    </div>
                                </li>
                            </ol>
                 </div>
               ...
               <div class="grid grid-cols-2">
                 <div>
                    <div class="flex justify-between items-center mb-6">
                        <h1 class="text-sm font-semibold text-gray-600 dark:text-gray-300">Edit State</h1>
