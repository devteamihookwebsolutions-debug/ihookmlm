                    ...
                    <ol class="inline-flex items-center space-x-1 md:space-x-1 rtl:space-x-reverse">
                        ...
                        <li aria-current="page">
                            <div class="flex items-center">
                                ...
                                <span class="text-xs font-medium text-gray-500 dark:text-gray-400">Graphical Genealogy</span>
                            </div>
                        </li>
                    </ol>
                </div>
                        ...
                        <div class="flex items-center justify-between space-x-4" bis_skin_checked="1">
                            ...
                            <div class="w-full max-w-xs" bis_skin_checked="1">
                                <select id="selectTemplate" name="selectTemplate"
                                    ...
                                    <option value="polina" selected>polina</option>
...
@include('admin::genealogy.components.binary_graphical_script')
@endsection
