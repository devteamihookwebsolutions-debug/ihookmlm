...
/**
 * This class contains public functions related to GenerationBonusController
 *
 * @package         GenerationBonusController
 * @category        Controller
...
use Ecomputing\App\Model\Wordpress\MGenerationBonus;
class GenerationBonusController extends Controller
{
    ...
    */
	...
	/**
     * This public function is used  to check discount group
     *
     */
    public function sendGenerationBonus()
    {
        $generationBonus = new MGenerationBonus();
        $generationBonus->sendGenerationBonus();
    }
