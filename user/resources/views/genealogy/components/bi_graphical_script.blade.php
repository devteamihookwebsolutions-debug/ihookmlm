        ...
        <script type="text/javascript" src="https://promlm.b-cdn.net/assets/custom/js/OrgChart.js"></script>
        <script
            type="text/javascript">{!!$genealogy!!}</script>
        <script type="text/javascript">
            ...
            var chart = new OrgChart(document.getElementById("grptree"), {
                ...
                nodeMenu: {
                    call: {
                        text: "View",
                        icon: webcallMeIcon,
                        onClick: function (nodeId) {  // Ensure the click event is attached
                            callHandler(nodeId);
                        }
                    }
                },
            ...
            function callHandler(nodeId) {
                ...
                if (nodeData["name"] != '' || nodeData["pid"] == '0') {
                    window.location.href = "https://iconv16.tradetrailblazer.com/admin/memberarea/show/" + nodeId;
                } else {
                    window.open("https://iconv16.tradetrailblazer.com/user/register/" + "N3J2dGFLcjQzV21FdEtGZ2YrV1VlcjJSNXFxWGlTdHZZMHdGdHBxWVd2N1JFOVJzcmU4dDBrek9pL009/" + "/" + nodeData["pid"] + "/" + nodeData["position"], "_blank");
                }
            }
            function applyTemplate() {
                ...
                Swal.fire({
                    ...
                    customClass: {
                        confirmButton: 'bg-gray-500 text-white hover:bg-gray-600 font-semibold py-2 px-4 rounded-lg',
            ...
            document.getElementById('default_matrix').addEventListener('change', function () {
                ...
                if (matrix_id > 0) {
                    ...
                    fetch("{{config('app.ADMINPATH')}}/genealogy/getcryptdata", {
                        method: "POST",
                        headers: {
                        ...
                        window.location.href = "{{config('app.ADMINPATH')}}/grpgenealogy/viewtree/"+ data;
                        })
                        .catch(error => {
