                    ...
                    <form action="{{ route('countries.store') }}" method="POST">
                        ...
                        <div  class="space-y-3">
                            <div>
                                ...
                                <input type="text" id="sortname" name="sortname" maxlength="3" class="bg-gray-50 border border-gray-300 text-gray-600 text-xs rounded-lg block w-full p-2 dark:bg-gray-800 dark:border-gray-700 dark:text-gray-300" required>
                                @error('sortname')
