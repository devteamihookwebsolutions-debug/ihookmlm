...
<!-- custom styles start-->
    ...
    <link rel="stylesheet" href="https://cdn.jsdelivr.net/npm/jstree@3.2.1/dist/themes/default/style.min.css" />
    <script src="https://cdn.jsdelivr.net/npm/jstree@3.2.1"></script>
<link href="{{ asset('/css/treestyle.css') }}" rel="stylesheet" type="text/css" />
