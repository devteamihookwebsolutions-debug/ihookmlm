            ...
            <ol class="inline-flex items-center space-x-1 md:space-x-1 rtl:space-x-reverse">
                ...
                <li aria-current="page">
                    <div class="flex items-center">
                        ...
                        <span class="text-xs font-medium text-gray-500 dark:text-gray-400">Send Bonus
</span>
                    </div>
                </li>
            </ol>
        ...
        <main class="flex-grow">
            <div class="container mx-auto px-4 sm:px-6 lg:px-0 py-6 lg:py-3">
                ...
                <div class="flex p-4 mb-6 text-xs text-blue-800 rounded-lg bg-blue-50 dark:bg-gray-800 dark:text-blue-400 border border-blue-300"
                    ...
                    <div>
                        <div>
                            <p class="mb-2">Using this tool you can send a bonus to your customers like Gift, Achievement Bonus etc.., It will be reflected in Customers C-Wallet or E-Wallet</p>
                        </div>
                    </div>
                </div>
                                    ...
                                    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 gap-5">
                                        ...
                                        <div class="col-span-1 md:col-span-1 lg:col-span-1 mb-5">
                                            <form name="Sendbonus" id="Sendbonus" method="POST"
                                               action="{{ route('admin.updatebonus') }}"
