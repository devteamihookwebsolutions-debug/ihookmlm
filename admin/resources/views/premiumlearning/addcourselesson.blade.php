<form name="addprelesson" id="addprelesson" method="POST" action="" enctype="multipart/form-data"
            ...
            <div class="hidden p-4 rounded-lg bg-neutral-50 dark:bg-neutral-900" id="lessonsettings" role="tabpanel"
                ...
                <div class="grid grid-cols-1 md:grid-cols-1 gap-6">
                    <div class="mb-5">
                        ...
                        <input type="number" min="0" id="video_duration" name="video_duration"
                    ...
                    <div class="mb-5">
                        ...
                        <select id="video_mode" name="video_mode"
                            class="text-sm rounded-lg focus:ring-neutral-500 focus:border-neutral-500 block w-full p-2.5 dark:bg-neutral-900 dark:text-white border border-neutral-200 dark:border-neutral-800  dark:placeholder-neutral-400 dark:focus:ring-neutral-500 dark:focus:border-neutral-500"
                            onchange="showvideos(this.value);" required>
                            <option value=""> {{ __('Select Video Mode') }} </option>
                            <option value="1"> {{ __('From Directory') }} </option>
                            <option value="2" selected> {{ __('Add New') }}</option>
                            <option value="3"> {{ __('Embed URL') }} </option>
                        </select>
                    </div>
                    ...
                    <div class="mb-5 hidden" id="show_embed_video">
                        ...
                        <input type="number" min="0" id="totaltitleone" name="totaltitleone"
                            class="text-sm rounded-lg focus:ring-neutral-500 focus:border-neutral-500 block w-full p-2.5 dark:bg-neutral-900 dark:text-white border border-neutral-200 dark:border-neutral-800  dark:placeholder-neutral-400 dark:focus:ring-neutral-500 dark:focus:border-neutral-500">
                    </div>
                    ...
                    <div class="mb-5"  id="show_add_video">
                        ...
                        <div class="mb-5">
                            ...
                            <input type="file" accept="video/*" name="video_path" id="video_path"
                                class="block w-full text-sm text-black rounded-lg cursor-pointer bg-neutral-50 dark:text-white focus:outline-none dark:bg-neutral-900 border border-neutral-200 dark:border-neutral-800  dark:placeholder-neutral-400"
                        ...
                        <div id="preview_container_add_video" class="mt-5">
                            <div
                                ...
                                <div class="flex flex-col items-center p-10">
                                    <!-- Placeholder Image or Icon -->
                                    <iframe width="200" height="200" id="image_preview_add_video" src="{{$_ENV['UI_ASSET_URL']}}/public/assets/img/noimage.png">
                                    </iframe>
                    ...
                    <div class="mb-5">
                        ...
                        <div class="mb-5">
                            ...
                            <input type="file" accept=".pdf" name="doc_path" id="doc_path"
                                class="block w-full text-sm text-black rounded-lg cursor-pointer bg-neutral-50 dark:text-white focus:outline-none dark:bg-neutral-900 border border-neutral-200 dark:border-neutral-800  dark:placeholder-neutral-400"
                        ...
                        <div id="preview_container_document" class="mt-5">
                            <div
                                ...
                                <div class="flex flex-col items-center p-10">
                                    <!-- Placeholder Image or Icon -->
                                    <object id="image_preview_document" data="{{$_ENV['UI_ASSET_URL']}}/public/assets/img/noimage.png#scrollbar=0&amp;;view=Fit" type="application/pdf" style="width:100%;height:300px" internalinstanceid="127"></object>
{{--  
                    ...
                    <div class="mb-5">
                        ...
                        <div class="mb-5">
                            ...
                            <input name="audio_path" id="audio_path" type="file" accept="audio/*"
                                class="block w-full text-sm text-black rounded-lg cursor-pointer bg-neutral-50 dark:text-white focus:outline-none dark:bg-neutral-900 border border-neutral-200 dark:border-neutral-800  dark:placeholder-neutral-400"
                        ...
                        <div id="preview_container_audio" class="mt-5">
                            ...
                            <div
                                ...
                                <div class="flex flex-col items-center p-10">
                                    <!-- Placeholder Image or Icon -->
                                    <audio  src="{{$_ENV['UI_ASSET_URL']}}/public/assets/img/noimage.png" id="image_preview_audio" controls="">
                            ...
                            <td class="px-6  text-right">
                                <div class="flex items-center p-2.5">
                                    ...
                                    <label class="inline-flex items-center cursor-pointer mx-3">
                                        <input type="checkbox" name="lesson_status" id="lesson_status"
        ...
        <div class="flex items-center justify-end p-4 md:p-5 border-t border-neutral-200 rounded-b ">
            <button type="button" id="submitLessonButton"
