...
use Ecomputing\App\Model\Wordpress\MCustomerBonus;
class CustomerBonusController extends Controller
{
    ...
    */
    ...
    public function sendCustomerBonus(){

        $customers_shop_id=$_POST['user_id'];
        $order_id=$_POST['order_id'];
        $amount=$_POST['amount'];
        $MCustomerBonus = new MCustomerBonus();
        $MCustomerBonus->sendCustomerBonus(
