...
<div class="py-5 lg:py-1">
    <div class="flex justify-between items-center py-3 w-[95%] mx-auto flex-wrap">
        ...
        <h2 class="text-lg font-medium text-black dark:text-white  mb-2">{{ __('Graphical Genealogy') }}</h2>
                   ...
                   <li class="inline-flex items-center">
                    ...
                    <li aria-current="page">
                        <div class="flex items-center">
                            ...
                            <span
                                class="ms-1 text-xs font-medium text-black md:ms-2 dark:text-white">{{ __('Graphical Genealogy') }}</span>
                        </div>
                    </li>
                </ol>
            </nav>
...
@include('genealogy.components.graphical_script')
