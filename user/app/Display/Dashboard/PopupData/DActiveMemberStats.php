...
/**
 * This class contains public functions related to DActiveMemberStats
 *
 * @package         DActiveMemberStats
 * @category        Display
...
class DActiveMemberStats
{

    public static function getActiveMemberStats($records,$iTotal)
    {
